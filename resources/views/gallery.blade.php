    ...
    <div class="container mx-auto px-6 py-16">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="group relative aspect-4/3 rounded-2xl overflow-hidden cursor-pointer">
                ...
                <div class="absolute inset-0 bg-linear-to-trom-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                    <h3 class="text-white font-semibold text-lg">Tax Summit 2025</h3>
                </div>
            </div>

            <div class="group relative aspect-4/3ounded-2xl overflow-hidden cursor-pointer">
