<x-admin-layout title="About Page Settings" header="About Page Settings">
    ...
    <form method="POST" action="{{ route('admin.settings.about.update') }}" enctype="multipart/form-data">
            ...
            @if(isset($settings[$groupKey]))
                <div class="bg-white rounded-xl border border-slate-200 p-6 mb-6">
                    <h3 class="text-sm font-bold text-slate-800 uppercase tracking-wider mb-5 pb-3 border-b border-slate-100">
                        <i class="fa-solid fa-id-card text-orange-500 mr-2"></i> {{ $groupLabel }}
                    </h3>
                    <div class="space-y-5">
        ...
        <div class="flex gap-3 justify-end">
            <a href="{{ route('admin.settings.index') }}" class="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-semibold rounded-lg transition">
                <i class="fa-solid fa-arrow-left mr-2"></i> Back to General Settings
            </a>
            <button type="submit" class="px-6 py-2.5 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-lg shadow transition">
                <i class="fa-solid fa-check mr-2"></i> Save About Settings
            </button>
        </div>
    </form>
