        ...
        <div class="container mx-auto px-6 relative z-10">
            <div class="max-w-2xl space-y-8 animate-fade-in-up">
                <h1 class="text-4xl md:text-6xl font-bold text-white leading-tight">
                    <span class="text-xl md:text-4xl font-medium block mb-2">Your Cost- Effective</span>
                    <span class="text-transparent bg-clip-text bg-linear-to-r from-orange-400 to-amber-300">Service Provider</span>
                </h1>
